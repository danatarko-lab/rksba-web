...
function grid(files, alt) {
  const items = files.map((f) => `        <img src="/images/mototrbo/${f}" alt="${alt}" loading="lazy" decoding="async" class="rounded-lg border border-hairline" />`).join('\n');
  return `\n      <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 my-4 not-prose">\n${items}\n      </div>`;
}

// mapa: subor -> [{ after, imgs:[file], alt }]
const MAP = {
  'mototrbo-priame-spojenie.astro': [{ after: PROSE, imgs: ['Direct_mode_Simple_Connection_2.jpg'], alt: 'MOTOTRBO Priame spojenie' }],
  'mototrbo-konvencny-system.astro': [{ after: PROSE, imgs: ['Conventional_Systems_Single_site_2.jpg'], alt: 'MOTOTRBO Konvenčný systém, jedna lokalita' }],
  'mototrbo-ip-site-connect.astro': [
    { after: PROSE, imgs: ['Conventional_Systems_IP_Site_Connect_2.jpg'], alt: 'MOTOTRBO IP Site Connect' },
    { after: '<h2>Scenáre použitia</h2>', imgs: ['Mototrbo_IP_Site_Connect_lokality.jpg'], alt: 'Lokality prepojené cez IP Site Connect' },
  ],
  'mototrbo-connect-plus.astro': [
    { after: PROSE, imgs: ['Mototrbo_Connect_Plus_1_th.jpg'], alt: 'MOTOTRBO Connect Plus' },
    { after: '<h2>Architektúra systému</h2>', imgs: ['Mototrbo_Connect_Plus_architecture_2.jpg'], alt: 'Architektúra systému Connect Plus' },
    { after: '<h3>Podpora až 250 lokalít</h3>', imgs: ['Mototrbo_Connect_Plus_USA_2.jpg'], alt: 'Connect Plus v prevádzke' },
  ],
  ...
  'mototrbo-capacity-max.astro': [
    ...
    { after: '<h2>Centrálna správa pre kompletné ovládanie</h2>', imgs: ['Mototrbo_Capacity_Max_6.jpg'], alt: 'Centrálna správa Capacity Max' },
    { after: '<h2>Vysoké zabezpečenie</h2>', imgs: ['Mototrbo_Capacity_Max_7.jpg'], alt: 'Zabezpečenie Capacity Max' },
    { after: '<h2>Zvýšená kapacita a ľahká škálovateľnosť</h2>', imgs: ['Mototrbo_Capacity_Max_1.jpg'], alt: 'Škálovateľnosť Capacity Max' },
  ],
  'mototrbo-ion.astro': [
  ...
  'mototrbo-dmr-technologia.astro': [
    ...
    { after: '<h2>Čistejšia hlasová komunikácia pri väčšom pokrytí</h2>', imgs: ['Mototrbo_kvalita_zvuku_2.jpg'], alt: 'Kvalita zvuku MOTOTRBO' },
    ...
    { after: '<h2>Rozšíriteľnosť</h2>', imgs: ['Mototrbo_system_porovnanie_2.jpg'], alt: 'Porovnanie systémov MOTOTRBO' },
  ],
  'wave-ptx.astro': [
    ...
    { after: '<h2>WAVE 3000 Server</h2>', imgs: ['Wave_CPS.jpg', 'Wave_CP.jpg', 'Wave_LCP.jpg'], alt: 'WAVE v systémoch MOTOTRBO' },
  ],
  'mototrbo-rdac.astro': [
  ...
  'rozsirena-zaruka.astro': [{ after: '<h2>Čo záruka pokrýva</h2>', imgs: ['Service_11.jpg'], alt: 'Servis rádiostaníc MOTOTRBO' }],
  'vyhody-akumulatorov-nabijaciek.astro': [
    { after: '<h2>Konštrukcia akumulátora</h2>', imgs: ['Battery_pack_1_SK.jpg'], alt: 'Konštrukcia akumulátora Motorola' },
    { after: '<h3>Ploché vodiče namiesto drôtov</h3>', imgs: ['Battery_pack_2_SK.jpg'], alt: 'Ploché vodiče v akumulátore' },
  ...
  'vyhody-impres.astro': [
    ...
    { after: '<h2>IMPRES Battery Fleet Management</h2>', imgs: ['IMPRES_Battery_Fleet_06.jpg', 'IMPRES_Battery_Fleet_07.jpg', 'IMPRES_Battery_Fleet_08.jpg', 'IMPRES_Battery_Fleet_09.jpg', 'IMPRES_Battery_Fleet_10.jpg'], alt: 'IMPRES Fleet Management' },
    { after: '<h3>Monitorovanie v reálnom čase</h3>', imgs: ['IMPRES_Battery_Fleet_11.jpg'], alt: 'Monitorovanie akumulátorov' },
    { after: '<h3>Bezdrôtový manažment (Over The Air)</h3>', imgs: ['IMPRES_Battery_Fleet_OTA.jpg'], alt: 'OTA manažment akumulátorov' },
  ],
  'vyhody-bezdrotoveho-prislusenstva.astro': [
    { after: '<h2>Pohodlie</h2>', imgs: ['Wireless_01.jpg'], alt: 'Bezdrôtové príslušenstvo' },
    { after: '<h2>Bezpečnosť a spoľahlivosť</h2>', imgs: ['Wireless_02.jpg'], alt: 'Bezpečnosť bezdrôtového príslušenstva' },
    ...
    { after: '<h2>Voľba príslušenstva</h2>', imgs: ['Wireless_05.jpg', 'Wireless_06.jpg', 'Wireless_07.jpg', 'Wireless_08.jpg', 'Wireless_09.jpg', 'Wireless_10.jpg'], alt: 'Bezdrôtové príslušenstvo OCW' },
  ...
  'vyhody-sluchadiel.astro': [
    ...
    { after: '<h3>Jednošnúrové slúchadlá</h3>', imgs: ['Sluchadlo_02.jpg', 'Sluchadlo_03.jpg'], alt: 'Jednošnúrové slúchadlo' },
    { after: '<h3>Dvojšnúrové slúchadlá</h3>', imgs: ['Sluchadlo_04.jpg', 'Sluchadlo_05.jpg'], alt: 'Dvojšnúrové slúchadlo' },
    { after: '<h3>Trojšnúrové slúchadlá</h3>', imgs: ['Sluchadlo_06.jpg', 'Sluchadlo_07.jpg'], alt: 'Trojšnúrové slúchadlo' },
  ...
  'vyhody-nahlavnych-suprav.astro': [
    ...
    { after: '<h2>Ultraľahké a ľahké súpravy</h2>', imgs: ['Headset_01.jpg', 'Headset_02.jpg', 'Headset_03.jpg'], alt: 'Ľahké náhlavné súpravy' },
    ...
    { after: '<h3>Exkluzívne IMPRES súpravy</h3>', imgs: ['Headset_06.jpg', 'Headset_09.jpg'], alt: 'IMPRES náhlavná súprava' },
    { after: '<h2>Schvaľovanie a legislatíva</h2>', imgs: ['DoC.jpg'], alt: 'Vyhlásenie o zhode' },
  ],
  'vyhody-audioprislusenstva-impres.astro': [
    { after: '<h3>Priemyselné repromikrofóny s potlačením hluku</h3>', imgs: ['IMPRES_Audio_04.jpg'], alt: 'Priemyselný repromikrofón' },
    { after: '<h3>Súpravy pre skryté nosenie</h3>', imgs: ['IMPRES_Audio_06.jpg'], alt: 'Súprava pre skryté nosenie' },
    { after: '<h3>Náhlavná súprava s kostným vedením</h3>', imgs: ['IMPRES_Audio_07.jpg', 'IMPRES_Audio_08.jpg'], alt: 'Náhlavná súprava s kostným vedením' },
  ],
  'vyhody-prislusenstva-na-nosenie.astro': [
    { after: PROSE, imgs: ['Carry_01_Clip.jpg', 'Carry_02_Nylon_Carry_Case.jpg', 'Carry_03_Leather_carry.jpg', 'Carry_04_Strap.jpg', 'Carry_05_Aqua.jpg', 'Carry_06_Chest_pack.jpg'], alt: 'Príslušenstvo na nosenie' },
  ...
  'vyhody-prislusenstva-pre-vozidlo.astro': [
    { after: PROSE, imgs: ['Vehicle_01.jpg', 'Vehicle_02.jpg', 'Vehicle_03.jpg', 'Vehicle_04.jpg', 'Vehicle_05.jpg', 'Vehicle_06.jpg', 'Vehicle_07.jpg', 'Vehicle_08.jpg'], alt: 'Príslušenstvo pre vozidlá' },
    ...
    { after: '<h2>Bezdrôtové Bluetooth príslušenstvo (OCW)</h2>', imgs: ['Vehicle_15.jpg'], alt: 'Bluetooth OCW do vozidla' },
  ...
  'vyhody-specialneho-prislusenstva.astro': [
    { after: '<h2>Diskrétna súprava pre kritické operácie</h2>', imgs: ['special_2.jpg'], alt: 'Diskrétna súprava pre kritické operácie' },
    { after: '<h2>IMPRES náhlavná súprava s kostným vedením</h2>', imgs: ['special_3.jpg'], alt: 'Náhlavná súprava s kostným vedením' },
    { after: '<h2>Windporting IMPRES repromikrofón</h2>', imgs: ['special_4.jpg'], alt: 'Windporting repromikrofón' },
    { after: '<h2>IMPRES INC repromikrofón do extrémne hlučných prevádzok</h2>', imgs: ['special_5.jpg'], alt: 'IMPRES INC repromikrofón' },
  ],
  'vyhody-audioprislusenstva-pre-vozidlo.astro': [
    ...
    { after: '<h2>PTT riešenia</h2>', imgs: ['IMPRES_Audio_13.jpg', 'IMPRES_Audio_14.jpg'], alt: 'PTT spínače do vozidla' },
    { after: '<h2>IMPRES ručný mikrofón</h2>', imgs: ['IMPRES_Audio_10.jpg', 'IMPRES_Audio_11.jpg'], alt: 'IMPRES ručný mikrofón' },
