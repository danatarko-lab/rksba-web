# RKS — finálny design brief v7
**Aktualizované:** jún 2026 (FINAL pre MVP - kompaktné dropdowny Variant A)
**Autor:** Dana Tarko + Claude
**Účel:** Vstupný brief pre Claude Code pri prerábaní Astrowind template

---

## CHANGELOG v7 (FINAL MVP)

**Menu kompaktizované (Variant A):**
- ✅ **Rádiokomunikácie**: 6 hlavných služieb + obsahový blok
- ✅ **Energetika**: 5 hlavných služieb + obsahový blok
- ✅ Zlúčené kategórie pre čistejší dropdown
- ✅ Detail služieb prístupný cez hub stránku `/radiokomunikacie` a `/energetika`

**Zostáva v platnosti z v6:
...
### Sekcia 6: Náš proces (NAHRÁDZA pôvodnú Partneri sekciu)
```
H2: Ako pri vás postupujeme
Subtitle: Diagnose first, sell later. Pred predajom rozumieme problém.
...
3. NÁVRH + BUSINESS CASE
   Konkrétny plán s ROI, financovanie, timeline.

4. REALIZÁCIA
   Projekt, dodávka, inštalácia s vašim minimom narušenia.
